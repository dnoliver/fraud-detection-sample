...
def generate_dataset(
    n_customers=10000, n_terminals=1000000, nb_days=90, start_date="2018-04-01", r=5
):
...
def save_raw_dataset(transactions_df):
    DIR_OUTPUT = Path(__file__).parent / "simulated-data-raw" / "data"
...
def main():
    ...
    save_raw_dataset(transactions_df)
