...
from utils import read_from_files
...
def transform_dataset(transactions_df):
...
def save_transformed_dataset(transactions_df):
    DIR_OUTPUT = Path(__file__).parent / "simulated-data-transformed" / "data"
    ...
    for day in range(transactions_df.TX_TIME_DAYS.max() + 1):
        ...
        transactions_day.to_pickle(str(DIR_OUTPUT) + "/" + filename_output, protocol=4)


def main():
    DIR_INPUT = Path(__file__).parent / "simulated-data-raw" / "data"
